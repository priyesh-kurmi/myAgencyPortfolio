...
const Process = () => {
  ...
  return (
    <section id="process" className="py-20 bg-zinc-950 relative overflow-hidden">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="relative z-10 bg-black/20 backdrop-blur-sm border border-white/5 rounded-3xl p-6 hover:border-white/10 hover:bg-black/30 transition-all duration-300 group h-full">
                ...
                {/* Icon */}
                <div className="text-blue-400 mb-5 group-hover:scale-110 group-hover:text-blue-300 transition-all">
                  {step.icon}
                </div>
